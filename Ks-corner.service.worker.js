...
/** @type {string} */
const CACHE_VERSION = '1781886767|48159620707';
/** @type {string} */
const CACHE_PREFIX = 'Ks-corner-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Ks-corner.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Ks-corner.html","Ks-corner.js","Ks-corner.offline.html","Ks-corner.icon.png","Ks-corner.apple-touch-icon.png","Ks-corner.audio.worklet.js","Ks-corner.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Ks-corner.wasm","Ks-corner.pck"];
